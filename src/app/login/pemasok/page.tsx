...
export default function PemasokLoginPage() {
  return (
      ...
      <div className="w-full max-w-md space-y-8 bg-white p-8 rounded-2xl shadow-sm border border-[var(--color-border)]">
        <div>
          ...
          <h2 className="text-center text-2xl font-extrabold text-[var(--color-foreground)]">
            Masuk sebagai Pemasok
          </h2>
          <p className="mt-2 text-center text-sm text-[var(--color-muted-foreground)]">
            Ubah sisa makanan restoran Anda menjadi saldo digital.
          </p>
        </div>
        <form className="mt-8 space-y-6">
          <div className="space-y-4">
            <div className="space-y-2">
              ...
              <Input id="email" name="email" type="email" autoComplete="email" required placeholder="nama@warung.com" />
            </div>
            <div className="space-y-2">
        ...
        <div className="text-center text-sm text-[var(--color-muted-foreground)]">
          ...
          <Link href="/register/pemasok" className="font-medium text-[var(--color-primary)] hover:underline">
            Daftar sekarang
          </Link>
        </div>
      </div>
